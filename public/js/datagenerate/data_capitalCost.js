...
const data_capitalCost = {
    ...
    getCapcost(userInput, callingPorts) {
        let ratio = CONST.dmuVariableTimes['capitalCost'] / CONST.dmuVariableTimes['member'];
...
// console.log(data_capitalCost.getCapcost(CONST.userInput, CONST.callingPorts));

module.exports = data_capitalCost;
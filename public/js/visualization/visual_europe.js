            ...
            L.marker([port.coordinates[1], port.coordinates[0]], { icon: customIcon }).addTo(lrmap)
                ...
                <tr style="background-color: rgba(0, 0, 0, 0.6); border-bottom: 1px solid #ccc;">
                    ...
                    <iframe width="500" height="500" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" 
                        src="https://www.openstreetmap.org/export/embed.html?bbox=${port.coordinates[0] - 0.01}%2C${port.coordinates[1] - 0.01}%2C${port.coordinates[0] + 0.01}%2C${port.coordinates[1] + 0.01}&layer=mapnik&marker=${port.coordinates[1]}%2C${port.coordinates[0]}" style="border: 1px solid #ccc; border-radius: 10px; margin-top: 30px;">
                    </iframe>
                `, {
                    maxWidth: 600,
                    maxHeight: 650,
